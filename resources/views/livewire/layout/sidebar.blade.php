...
>
    ...
    >
        ...
        @if(auth()->user()->can('isi-logbook') || auth()->user()->can('akses-tridharma') || auth()->user()->can('verifikasi-logbook'))
            ...
            <x-nav-link-sidebar class="{{ request()->routeIs('kinerja.tridharma.*') ? 'sidebar-active' : '' }}" :href="route('kinerja.tridharma.index')" :active="request()->routeIs('kinerja.tridharma.*')" wire:navigate>
